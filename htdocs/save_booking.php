...
// 入力チェック
if (!$teacher_id || !$lesson_type_id || !$date || !$time) {
...
$stmt = $db->prepare(
    'INSERT INTO comments
       (Login_number, teacher_id, Lesson_date, Lesson_time, lesson_type_id)
     VALUES
       (:ln, :tid, :d, :t, :ltid)'
);
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="lesson-info">
        ...
        <p><strong>受講者番号：</strong> <?= h($_SESSION['Login_number']) ?></p>
      </div>
      <div style="text-align:center; margin-top:20px;">
        <a href="booking.php" class="btn">予約一覧へ戻る</a>
      </div>
    </div>
  </div>
</body>
