...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['reserve'])) {
    ...
    $schedule_id = $_POST['schedule_id']; // スケジュール ID を取得する
    ...
    // 予約を挿入する
    $stmt_reserve = $db->prepare("INSERT INTO reservations (user_id, seat_id, car_number, schedule_id, reservation_time) VALUES (?, ?, ?, ?, ?)");
